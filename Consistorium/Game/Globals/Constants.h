...
namespace Globals
{
	...
	/*const b2Vec2 AIR_LAYER_HEIGHT_RANGE(10, 10);
	const b2Vec2 GROUND_LAYER_HEIGHT_RANGE(10, 10);
	const b2Vec2 UNDERGROUND_LAYER_HEIGHT_RANGE(10, 10);
	const b2Vec2 RUIN_LAYER_HEIGHT_RANGE(10, 10);
	const b2Vec2 HELL_LAYER_HEIGHT_RANGE(10, 10);
	const b2Vec2 PURGATORY_LAYER_HEIGHT_RANGE(10, 10);*/
